    ...
    while numero != "-1":
        ...
        if numero == "1":  # Buscar libro
            ...
            if not libros_encontrados:
                print("\033[31m❌ No encontramos ese libro en nuestra biblioteca.\033[0m")
            else:
            ...
            while not genero_valido:
                print("\033[31m❌ El género ingresado es incorrecto. Intenta nuevamente.\033[0m")
...
def menu_bibliotecario():
    ...
    while numero != "-1":
        ...
        if numero == "1":  # Cargar libro
            ...
            #TODO: Revisar este print, no imprime bien todos lso libros de la biblioteca
            ...
            while validar != -1:
                ...
                if libro is None and validar != -1:
                    print("\033[31m❌ No encontramos el libro. Intenta con otro ISBN.\033[0m")
                    continue
            ...
            bandera = True
            while bandera:
                input_usuario = input("¿Qué libro deseas alquilar? 📚 o -1 para salir: ")
                        ...
                        if continuar_ejecucion == 1:
                            ...
                            if bandera:
                                ...
                                if buscar_isbn is None:
                                    print("\033[31m❌ El ISBN es incorrecto o no existe.\033[0m")
                                    continue
                                else:
                                    nro_pedidos = None
                                    while nro_pedidos is None and bandera:
                                        cantidad_pedidos = input("¿Cuántos ejemplares deseas? 📦: ")
                                    ...
                                    if bandera:
                                        ...
                                        print("\033[31m❌ No hay suficientes ejemplares disponibles.\033[0m")
            ...
            isbn = 0
            while isbn != -1:
                pedir_isbn = input("Ingresa el ISBN del libro a devolver 📖 o -1 para salir: ")
                isbn = su.validacion_enteros(pedir_isbn)
